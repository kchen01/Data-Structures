...
public class CountryDisplayer {
    ...
    public void displayCountriesAsText(){
      for (int i = 0; i < this.list.size(); i++) {
            ...
            this.list.get(i).getIndicator("TotalGreenhouseGasEmissions") + "," +
    ...
    public static boolean checkIndicator(String ind) {
        ...
        case "UrbanPopulationGrowth":
            return true;
        default:
            System.out.println("please input the right indicator format: CO2Emissions, TotalGreenhouseGasEmissions, AccessToElectricity, RenewableEnergy, ProtectedAreas, PopulationGrowth, PopulationTotal, or UrbanPopulationGrowth");
            return false;
        }
    }
                  ...
                  case "add country":
                      ...
                      while(validCountryInput == false){
                          System.out.println("Type in the information for the country with each indicator separated by a comma."
                           ...
                           + "Country Name,CO2 emissions (metric tons per capita),Total greenhouse gas emissions (kt of CO2 equivalent),"
